    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-3/5 space-y-8">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <button className="bg-[#1E293B] hover:bg-[#F58220] text-white rounded-full px-10 py-4 font-bold transition-all shadow-lg active:scale-95">
                  Book a Consultation
                </button>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-8 bg-slate-50 dark:bg-slate-900/50 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex gap-4">
                ...
                <p className="text-sm font-bold text-slate-700 dark:text-slate-300">National/State Conference Presenter & Organizing Secretary</p>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="p-5 rounded-2xl border border-slate-100 dark:border-slate-800 hover:border-emerald-200 transition-all">
      ...
      <section className="bg-slate-900 py-16">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-6">
           <h2 className="text-3xl font-black text-white uppercase tracking-tighter">Recognized Clinical Excellence</h2>
           <div className="flex flex-wrap justify-center gap-8 opacity-60">
              <div className="flex items-center gap-2 text-white font-bold"><ShieldCheck className="text-[#F58220]" /> ISO 9001:2008 Certified</div>
              <div className="flex items-center gap-2 text-white font-bold"><Award className="text-[#F58220]" /> VSSC Approved Center</div>
              <div className="flex items-center gap-2 text-white font-bold"><MapPin className="text-[#F58220]" /> Trivandrum, Kerala</div>
           </div>
        </div>
      </section>
    </div>
